                    ...
                    <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                            <div class="container-fluid">
                                <div class="navbar-wrapper">
                                    ...
                                    <a class="navbar-brand" href="#">{{ $page ?? __('Photos) }}</a>
                                </div>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('photos.create') }}" class="btn btn-sm btn-primary">Add Photo</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('photos.destroy',$data->id) }}" method="POST">
                                        ...
                                        <a class="btn btn-info" href="{{ route('photos.show',$data->id) }}">Show</a>
